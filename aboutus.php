...
// SQL query to fetch data where id is 1
$sql = "SELECT aheading, adescription FROM aboutus WHERE id = 1";
...
<html lang="en">
  ...
  <header>
    ...
    <main>
        <section>
            <div class="photo">
                <img src="./assets/about.png" alt="background picture" />
            </div>
        </section>
        <section class="sec-gap privacy">
            <div class="custom-container">
                  ...
                  <div class="mid-sec">
                    <div class="quick-link">
                      ...
                      <ul>
                        ...
                        <li>
                          <a href="./index.html" target="_blank">Terms & Condition </a>
                        </li>
                    ...
                    <div class="services">
                      ...
                      <ul>
                        ...
                        <li>
                          <a href="" target="_blank">Medicine</a>
                        </li>
                      </ul>
                    </div>
                  </div>
                    ...
                    <div class="contact-info">
                      ...
                      <ul>
                        ...
                        <li>
                          ...
                          <p>
                            Dharampur,near Khadina More,Chinsurah,West Bengal
                            712101
                          </p>
                        </li>
                      </ul>
