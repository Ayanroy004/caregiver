...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submitAddress'])) {
    ...
    $altmobile = $conn->real_escape_string(trim($_POST['altmobile']));
    ...
    $fulladdress = $conn->real_escape_string(trim($_POST['fulladdress']));
    $landmark = isset($_POST['landmark']) ? $conn->real_escape_string(trim($_POST['landmark'])) : '';
    $totalamount = $conn->real_escape_string(trim($_POST['totalamount']));
    ...
    $address = "$fulladdress, $locality, $city, $pincode, $state";
    if ($landmark) {
        $address .= ", $landmark";
    }

    // Insert into customers table
    $sql = "INSERT INTO customer (fname, mobile,altmobile, address, totalamount) 
            VALUES ('$fullname', '$mobile', '$altmobile', '$address', '$totalamount')";
                ...
                <div class="col">
                    <div class="left-sec">
                        ...
                        <form method="post" action="">
                            <input type="hidden" name="totalamount" value="<?php echo htmlspecialchars($_GET['totalamount']); ?>">
                            <div class="row">
                                <div class="col-50 col-100">
                                    <div class="form-group">
                                        <label for="fullname">Enter Full Name : <span>*</span></label>
                                ...
                                <div class="col-50 col-100">
                                    <div class="form-group">
                                        <label for="city">City / District / Town : <span>*</span></label>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="fulladdress">Address : <span>*</span></label>
                                        <textarea id="fulladdress" name="fulladdress" required></textarea>
                                    </div>
                                </div>
                                <div class="col-50 col-100">
                                    <div class="form-group">
                                ...
                                <div class="col-50 col-100">
                                    <div class="form-group">
                                      <label for="altmobile">Enter Alternative number : </label>
                                      <input type="tel" id="altmobile" name="altmobile" />
                                    </div>
                                  </div>
                                <div class="col-12 btn-submit">
                                    <button class="full-button" name="submitAddress" type="submit">Submit</button>
                                </div>
                            </div>
                        </form>
                    </div>
                          ...
                          <defs>
                            <clipPath id="clip0_137_622">
                              <rect width="12" height="16" fill="white" />
                                ...
                                <h5><?php echo htmlspecialchars($_GET['totalamount']); ?></h5>
                            </div>
                        </div>
                        <div class="btn">
                            <button><a href="./medicinePayment.php">Checkout</a></button>
                        </div>
                    </div>
                </div>
            </div>
