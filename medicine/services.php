...
<html lang="en">
  <head>
    ...
    <link
      ...
      rel="stylesheet"
    />
    <!-- this is bootstrap cdn link for use checking purpose -->
  ...
  <body>
    ...
    <section class="hero">
      <div class="img-wrap divider">
        <img src="../assets/hero1.png" alt="" />
      </div>
    </section>

    <section class="sec-gap services-sec">
    <div class="custom-container">
        <h1>Services</h1>
        <div class="services-wrapper">
            <h1>Our CareGiver Services</h1>
            <div class="cards-wrapper">
                <?php
                include "config.php";
                // Fetch services from the database
                $sql = "SELECT id, title, image, reference FROM services";
                $result = $conn->query($sql);

                if ($result->num_rows > 0) {
                    // Output data for each service as a card
