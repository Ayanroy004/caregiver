...
<html lang="en">
  ...
  <body>
    ...
    <section class="hero medicine-home divider">
      <button class="prev-btn" onclick="onPrev()">
        <div class="svg">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="44"
      ...
      <div class="slide">
        <img src="../assets/hero1.png" class="slider" alt="slider-img" />
        <img src="../assets/Rectangle 59.png" class="slider" alt="slider-img" />
        <img src="../assets/banner2.png" class="slider" alt="slider-img" />
        <img src="../assets/banner3.jpg" class="slider" alt="slider-img" />
      </div>
    ...
    <section class="sec-gap medicine-sec divider">
    ...
    <div class="services-wrapper">
        <div class="custom-container">
            <div class="cards-wrapper">
                ...
                $sql = "SELECT title, reference, image FROM medicine";
                $result = $conn->query($sql);

                // Display each item as a card
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        echo '<a href="' . htmlspecialchars($row['reference']) . '" target="_blank">';
                    ...
                    echo "<p>No medicines found in the catalogue!</p>";
                }
