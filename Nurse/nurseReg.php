...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO nurse (nname, nimage, special, degree, location, mobile, aadhar_number, email)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssssssss", $nurse_name, $image, $speciality, $degree, $address, $mobile_number, $aadhar_number, $email);
...
<body>
    <h2>Register for Nurse</h2>

    <div class="register-form">
    <form action="" method="post" enctype="multipart/form-data"> <!-- Add enctype here -->
        <label>Full Name:</label>
        <input type="text" name="nurse_name" placeholder="Enter your full name "required><br><br>
